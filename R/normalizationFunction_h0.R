#' @title Normalization of given data h0
#'
...
#'
#' # Normalize Data
#' dataOutput <- normalizeData_h0(dataInput, dataInputName="sample001")
#'
...
#' @title Unnormalization of given data h0
#'
...
#' # Un Normalize it
#' dataOutput2 <- unnormalizeData_h0(dataInput2)
#'
unnormalizeData_h0 <-
  function(dataInput)
  {
