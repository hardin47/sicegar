#' @title additional parameter calculation with help of fits
#'
#' @param parameterVector Output of multiple fit function sicegar::multipleFitFunction() that gives the variables generated by the sigmoidal or double sigmoidal fit.
...
#'
#' @description Generates useful values for external use, using parameters existing in the parameterVector.
